...
./build/video/vga_virtual.o: ./src/video/vga_virtual.c
	i686-elf-gcc $(INCLUDES) -I./src/video $(FLAGS) -std=gnu99 -c ./src/video/vga_virtual.c -o ./build/video/vga_virtual.o
